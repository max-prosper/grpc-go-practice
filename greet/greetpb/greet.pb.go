...
func (*Greeting) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_1afd8dbc620cbcb0, []int{0}
}
...
func (*GreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_1afd8dbc620cbcb0, []int{1}
}
...
func (*GreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_1afd8dbc620cbcb0, []int{2}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_1afd8dbc620cbcb0, []int{3}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_greet_1afd8dbc620cbcb0, []int{4}
}
...
func init() { proto.RegisterFile("greet/greetpb/greet.proto", fileDescriptor_greet_1afd8dbc620cbcb0) }

var fileDescriptor_greet_1afd8dbc620cbcb0 = []byte{
